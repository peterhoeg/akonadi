    ...
    void testCreate_data()
    {
...

        {
            ...
            scenario << FakeAkonadiServer::defaultScenario()
                    << "C: 2 CREATE \"New Name\" 3 ()"
                    << "S: * 8 3 (NAME \"New Name\" MIMETYPE (application/octet-stream inode/directory) REMOTEID \"\" REMOTEREVISION \"\" RESOURCE \"akonadi_fake_resource_0\" VIRTUAL 0 CACHEPOLICY (INHERIT true INTERVAL -1 CACHETIMEOUT -1 SYNCONDEMAND false LOCALPARTS (ALL)) ENABLED TRUE DISPLAY DEFAULT SYNC DEFAULT INDEX DEFAULT )"
